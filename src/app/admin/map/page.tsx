...
export default function AdminMapPage() {
  return (
    <div>
      ...
      <div className="card h-[600px] w-full rounded-xl border border-stone-200 bg-stone-100 overflow-hidden shadow-md relative flex items-center justify-center flex-col gap-4 text-stone-500 stagger-2 transition-all hover:shadow-lg hover:-translate-y-1">
