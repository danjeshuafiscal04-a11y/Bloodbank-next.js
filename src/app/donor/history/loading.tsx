          ...
          <table className="data-table w-full">
            <thead>
              <tr>
                ...
                <th className="py-3 px-4"><div className="h-4 w-32 bg-stone-200 rounded"></div></th>
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <tr key={i} className="border-b border-stone-100">
                  ...
                  <td className="py-4 px-4">
                    <div className="h-5 w-40 bg-stone-200 rounded-md mb-1"></div>
                    <div className="h-4 w-48 bg-stone-100 rounded-md"></div>
                  </td>
                  <td className="py-4 px-4"><div className="h-5 w-12 bg-red-100 rounded-full"></div></td>
